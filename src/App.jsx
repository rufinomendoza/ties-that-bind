...
const COLORS = {
  blue: '#041E42',   // Primary Text / Dark Backgrounds
  darkGray: '#63666A', // Secondary Text
  lightGray: '#BBBCBC', // Borders / Subtle Text
  white: '#F4F4F3',   // Main Background (Paper)
  red: '#D50032',     // Accents / Hover
};
...
const SectionHeader = ({ title, number }) => (
  <div className="flex items-baseline justify-between border-b border-[#041E42] pb-4 mb-12 animate-fade-in">
...
const App = () => {
  ...
  useEffect(() => {
    ...
    link.href = 'https://use.typekit.net/uzl4kqy.css';
    link.rel = 'stylesheet';
      ...
      <div className="relative min-h-[90vh] flex flex-col justify-between pt-32 pb-12 px-6 md:px-12 border-b border-[#041E42]">
        <div className="max-w-[1920px] mx-auto w-full flex-grow flex flex-col justify-center relative z-10">
          <div className="max-w-4xl">
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-serif leading-[0.9] tracking-tight mb-8 text-[#041E42]">
              TRADITION<br />
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-end md:items-center gap-6">
        ...
        <div className="max-w-[1920px] mx-auto">
          <div className="flex flex-col md:flex-row gap-12 items-start">
            ...
            <div className="md:w-2/3 w-full aspect-video flex items-center justify-center overflow-hidden bg-[#E5E5E4]">
               {/* Cherry Tree Image */}
               <img 
                 src="Composite Set-Monochrome-Compressed.jpg" 
  ...
  const AgendaView = () => (
    <div className="min-h-screen pt-32 px-6 md:px-12 pb-24">
      <div className="max-w-[1920px] mx-auto">
        ...
        <div className="flex flex-col border-t border-[#041E42]">
  ...
  const DiscographyView = () => (
    <div className="min-h-screen pt-32 px-6 md:px-12 pb-24 bg-[#E5E5E4]">
      <div className="max-w-[1920px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-[#BBBCBC] border border-[#BBBCBC] mb-24">
          {ALBUMS_DATA.map((album) => (
            ...
            >
              ...
              <div className={`w-full h-full absolute inset-0 ${album.cover} flex items-center justify-center opacity-0 group-hover:opacity-10 transition-opacity duration-700`}></div>
        ...
        <div className="border-t border-[#041E42] pt-12 flex flex-col md:flex-row gap-12">
            <div className="md:w-1/3">
    ...
    <div className="min-h-screen pt-32 px-6 md:px-12 pb-24 bg-[#F4F4F3]">
      <div className="max-w-[1920px] mx-auto">
        <button 
          ...
          className="mb-12 text-xs font-bold tracking-[0.2em] uppercase flex items-center gap-2 hover:text-[#D50032] transition-colors text-[#041E42]"
        >
  ...
  const PhilanthropyView = () => (
    <div className="min-h-screen bg-[#F4F4F3] text-[#041E42] pt-32 px-6 md:px-12 pb-24">
       <div className="max-w-[1920px] mx-auto">
        ...
        {/* Guild Tiers Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-[#BBBCBC] border border-[#BBBCBC] mb-32">
        ...
        {/* One Time Gift */}
        <div className="flex flex-col md:flex-row gap-12 md:gap-24 border-t border-[#041E42] pt-24">
             <div className="md:w-1/3">
        ...
        {/* Management */}
        <div className="mt-32 pt-12 border-t border-[#BBBCBC]/20 text-center">
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F3] text-[#041E42] font-sans selection:bg-[#041E42] selection:text-[#F4F4F3]">
      {/* Font Overrides */}
      <style>{`
        :root {
        ...
        body, .font-sans { font-family: "neue-haas-unica", sans-serif !important; }
        .font-serif { font-family: "adobe-caslon-pro", serif !important; }
      `}</style>
      ...
      <main className="fade-in-element">
        ...
        {activePage === 'album_detail' && <AlbumDetailView />}
      ...
      <footer className={`${activePage === 'philanthropy' ? 'bg-[#041E42] text-[#F4F4F3] border-[#041E42]' : 'bg-[#F4F4F3] text-[#041E42] border-[#041E42]'} py-20 px-6 md:px-12 border-t transition-colors duration-500`}>
        <div className="max-w-[1920px] mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
          ...
          <div className="md:w-2/3 flex flex-wrap gap-12 md:gap-24">
             {/* Updated Footer Links per request */}
             <div className="flex flex-col gap-4">
