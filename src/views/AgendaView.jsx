...
const AgendaView = ({ navigateTo, openEvent }) => {
  ...
  return (
    <div className="min-h-screen pt-40 px-6 md:px-12 pb-32 bg-[#F4F4F3] text-[#041E42] antialiased selection:bg-[#D50032] selection:text-white">
      <Helmet>
        <title>Box Office | Georgetown Chimes Alumni Association, Inc.</title>
      ...
      <div className="max-w-[1920px] mx-auto">
        ...
        <div className="hidden md:grid grid-cols-12 gap-12 pb-4 mb-4 border-b-2 border-[#041E42] opacity-100" aria-hidden="true">
            <span className="col-span-2 text-[10px] font-mono font-bold tracking-[0.1em] uppercase">Date</span>
            <span className="col-span-7 text-[10px] font-mono font-bold tracking-[0.1em] uppercase">Program</span>
            <span className="col-span-3 text-[10px] font-mono font-bold tracking-[0.1em] uppercase text-right">Logistics</span>
        </div>
