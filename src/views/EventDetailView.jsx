        ...
        <div className="border-t-2 border-[#041E42] pt-12 grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-x-12">
          ...
          <div className="lg:col-span-4">
             <div className="sticky top-32">
                 <div className="aspect-[3/4] w-full bg-[#E5E5E4] mb-12 relative overflow-hidden shadow-2xl shadow-[#041E42]/5 group">
                    {event.image ? (
                        <ImageLoader 
                          src={event.image} 
                          alt={event.title} 
                          className="w-full h-full object-cover grayscale mix-blend-multiply group-hover:mix-blend-normal hover:grayscale-0 transition-all duration-[1.5s]"
                          curtainClassName="absolute inset-0 bg-[#E5E5E4] transition-opacity duration-800 pointer-events-none"
                        />
                    ) : <div className="w-full h-full bg-[#041E42]/5" />}
                </div>
                
                {/* LOGISTICS DATA — Kept in Mono for "Data" feel, but removed "Admit One" */}
                <div className="space-y-0 border-t border-[#041E42]">
                    ...
                    <div className="flex justify-between items-baseline py-4 border-b border-[#041E42]/20">
                        <span className="text-[10px] font-mono font-bold tracking-[0.1em] uppercase text-[#041E42]/70">Price</span>
                        <span className="text-[11px] font-mono font-bold tracking-[0.05em] text-right">{event.priceInfo || "See Link"}</span>
                    </div>
                </div>
          ...
          <div className="lg:col-span-8">
            ...
            {event.guestGroups && (
                <div className="mb-32 border-t-2 border-[#041E42] pt-12">
                    <span className="text-[11px] font-mono font-bold tracking-[0.05em] text-[#D50032] mb-12 block uppercase">Guest Groups</span>
            ...
            {event.schedule && (
              <div className="mb-32 border-t-2 border-[#041E42] pt-12">
                <span className="text-[11px] font-mono font-bold tracking-[0.05em] text-[#D50032] mb-12 block uppercase">Itinerary</span>
