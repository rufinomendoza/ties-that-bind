...
const NotFoundView = ({ navigateTo }) => {
    ...
    // Helper to preserve SPA behavior while allowing native link features
            ...
            <div className="w-full max-w-3xl border-t-2 border-[#041E42] pt-12">
                ...
                <div className="flex flex-col items-start gap-8">
                    ...
                    <div className="flex flex-wrap gap-6 pt-8 border-t border-[#041E42]/10 w-full max-w-md opacity-60">
                        <a href="/events" onClick={(e) => handleNav(e, 'agenda')} className="text-[10px] font-sans font-bold tracking-[0.2em] uppercase hover:text-[#D50032] transition-colors">Box Office</a>
                        <a href="/albums" onClick={(e) => handleNav(e, 'discography')} className="text-[10px] font-sans font-bold tracking-[0.2em] uppercase hover:text-[#D50032] transition-colors">Listening Room</a>
                        <a href="/give" onClick={(e) => handleNav(e, 'philanthropy')} className="text-[10px] font-sans font-bold tracking-[0.2em] uppercase hover:text-[#D50032] transition-colors">Patronage</a>
                    </div>
                </div>
